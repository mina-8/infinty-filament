    ...
    return (
        <LangWraper>
            ...
            >
                ...
                >
                    {!isnavbar && (
                        <div className="bg-secondary-color relative after:absolute after:w-full after:h-10 after:bg-secondary-color after:-z-10">
                            {/* top bar */}
                    ...
                    {/* navbar */}
                    <div
                        className={`bg-primary-color ${isnavbar ? "rounded-none" : "rounded-full mx-5 shadow-lg"} `}
                    >
                        <div
                            className={`mx-auto py-4 px-6 w-full max-w-screen-xl `}
                        >
                            <div className="flex h-16 ">
                                <div className="flex relative">
                                    <div className="flex shrink-0 items-center">
                                        ...
                                        >
                                            <ApplicationLogo className="lg:h-20 lg:block hidden w-auto fill-current " />
                                        </Link>
                                    </div>
                                </div>

                                <div
                                    className={`hidden xl:ms-6 xl:flex xl:items-center relative justify-between w-full`}
                                >
                                    <div className="hidden gap-4 sm:-my-px sm:ms-10 sm:flex items-center ">
                                        ...
                                        <Link
                                            ...
                                            className="font-bold text-lg text-white hover:text-secondary-color"
                                        >
                                            {t("blog.title")}
                                        </Link>
                                        <Link
                                    ...
                                    <div className="relative ms-3 flex items-center gap-4">
                                        <button
                                            name="search"
                                            type="button"
                                            className="inline-flex items-center rounded-full px-2 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out text-white hover:text-secondary-color"
                                        ...
                                        <Dropdown triggerType="click">
                                            <div className="flex items-center gap-2 cursor-pointer group text-white hover:text-secondary-color">
                                                <FaRegUser
                                                    size={24}
                                            ...
                                            >
                                                {user ? (
                                                    <div className="flex px-2 items-center flex-wrap justify-between gap-4 py-2">
                                                        <div className="border-2 rounded-lg flex items-center px-4 ">
                                                            <FaHeart />
                                                            <Dropdown.Link
                                                                href={route(
                                                                    "wish-list",
                        ...
                        <div className="space-y-1">
                            ...
                            >
                                <Link
                                            ...
                                            className="font-bold text-lg text-primary-color hover:text-secondary-color"
                                        >
                                            {t("blog.title")}
                                        </Link>
                                        <Link
                            ...
                            <span className="inline-flex rounded-md">
                                <button
                                    type="button"
                                    className="inline-flex items-center rounded-full bg-yellow-original  text-primary-color px-2 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out  focus:outline-none hover:text-secondary-color"
                                    onClick={() => setShowSearch(true)}
                                >
                                    <IoSearch size={24} />
                                </button>
